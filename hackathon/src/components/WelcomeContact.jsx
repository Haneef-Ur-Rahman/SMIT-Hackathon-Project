        ...
        <div className="max-w-5xl w-full bg-white rounded-2xl shadow-lg p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-[#334155] text-white py-2 rounded-lg font-medium hover:from-[#1e293b] hover:to-[#475569] transition"
              >
                Send Message
              </button>
            </form>
